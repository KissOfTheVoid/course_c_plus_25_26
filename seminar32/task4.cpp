/*
    Works with array, vector, concepts, deque, list libraries
    Concept ResizableContainer<T> that is satisfied if and only if type T
*/
...
int main() {
    ...
    // SafePusher<std::array<int, 5>> c;
    // SafePusher<int[10]> d;
    // SafePusher<std::list<int>> e;
