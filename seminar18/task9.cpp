/*
    Works with string, vector, cmath libraries
    System for storing heterogeneous configuration parameters: integers, real numbers, Booleans, and strings
*/
...
int main() {
    ...
    /*
    ---output---
    Radius has int type and  it's value: 64
    Pi has int type and  it's value: 3
    Human? has bool type and  it's value: true
    Alex has string type and  it's value: Name
    */
    return 0;
}
